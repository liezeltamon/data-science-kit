...
- Output (https://github.com/satijalab/seurat/issues/1957)
  + counts slot - Sequencing depth-corrected counts "reversed transforming" from Pearson residuals in data slot (https://github.com/satijalab/seurat/issues/2457)
  + data slot - Pearson residuals
  + scale.data slot - Pearson residuals scaled by the expected(?) sd, by default returned for variables genes determined by the method
